...
public class ListaClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabs.addTab("Lista de Cliente", tab1);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        switch (estado) {
            case 'C':
                clientesServicio.agregar(cliente);
                break;
            case 'E':
                clientesServicio.editar(cliente);
                break;
            default:
    ...
    private void obtenerDatos() {
        ...
        modelo.setColumnIdentifiers(clientesServicio.colunmasNombres);

        Object[] fila = new Object[modelo.getColumnCount()];

        for (Cliente c : clientesServicio.getClientes(txtBuscar.getText())) {
            fila[0] = c.getId();
            fila[1] = c.getNombre();
            fila[2] = c.getDni();
    ...
    private void tblDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDatosMouseClicked
        ...
        Cliente clienteEditar
                = clientesServicio.getClientes(valor.toString()).get(0);

        txtDni.setText(clienteEditar.getDni());
        txtDireccion.setText(clienteEditar.getDireccion());
        txtEmail.setText(clienteEditar.getEmail());
        txtId.setText(Integer.toString(clienteEditar.getId()));
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        clientesServicio.borrar(Integer.parseInt(txtId.getText()));
        goBack();
